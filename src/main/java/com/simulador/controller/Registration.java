...
public class Registration {
    ...
    public void inicializarSistema() {
        ...
        ClassGroup turmaAlgoritmos_1 = new ClassGroup("DCC119-01", algoritmos, 20, Arrays.asList(qua8h));
        ClassGroup turmaLabProg_1 = new ClassGroup("DCC120-01", labProgramacao, 15, Arrays.asList(qui8h));
        ClassGroup turmaOrientacaoObj_1 = new ClassGroup("DCC025-01", orientacaoObjetos, 20, Arrays.asList(sex8h));
        
        // Disciplinas com pré-requisitos simples
        ClassGroup turmaCalculoII_1 = new ClassGroup("MAT156-01", calculoII, 25, Arrays.asList(seg14h));
        ClassGroup turmaFisicaI_1 = new ClassGroup("FIS073-01", fisicaI, 25, Arrays.asList(ter14h));
        ClassGroup turmaEstruturaDados_1 = new ClassGroup("DCC013-01", estruturaDados, 20, Arrays.asList(qua14h));
        ClassGroup turmaModelagem_1 = new ClassGroup("DCC117-01", modelagemSistemas, 15, Arrays.asList(qui14h));
        ClassGroup turmaProgWeb_1 = new ClassGroup("DCC121-01", programacaoWeb, 15, Arrays.asList(sex14h));
        
        // Disciplinas avançadas
        ClassGroup turmaFisicaII_1 = new ClassGroup("FIS074-01", fisicaII, 20, Arrays.asList(seg16h));
        ClassGroup turmaEstruturaDadosII_1 = new ClassGroup("DCC012-01", estruturaDadosII, 15, Arrays.asList(ter16h));
        ClassGroup turmaTeoriaGrafos_1 = new ClassGroup("DCC059-01", teoriaGrafos, 15, Arrays.asList(qua16h));
        ClassGroup turmaMetodologia_1 = new ClassGroup("DCC123-01", metodologiaCientifica, 10, Arrays.asList(qui16h));
        ClassGroup turmaMonografia_1 = new ClassGroup("DCC110-01", monografiaFinal, 5, Arrays.asList(sex16h));
        ...
        // Cenário inicial: aluno cursou apenas disciplinas básicas
